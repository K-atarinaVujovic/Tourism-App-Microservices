...
func (x *AddToCartRequest) GetItem() *OrderItemRequest {
	if x != nil {
		return x.Item
	}
	return nil
...
const file_proto_purchase_proto_rawDesc = "" +
	...
	"\x04item\x18\x02 \x01(\v2\x1a.purchase.OrderItemRequestR\x04item\"O\n" +
...
var file_proto_purchase_proto_depIdxs = []int32{
	0, // 0: purchase.AddToCartRequest.item:type_name -> purchase.OrderItemRequest
	1, // 1: purchase.CartResponse.items:type_name -> purchase.OrderItemResponse
	6, // 2: purchase.CheckoutResponse.tokens:type_name -> purchase.TokenResponse
	2, // 3: purchase.PurchaseService.AddToCart:input_type -> purchase.AddToCartRequest
	3, // 4: purchase.PurchaseService.RemoveFromCart:input_type -> purchase.RemoveFromCartRequest
	5, // 5: purchase.PurchaseService.Checkout:input_type -> purchase.CheckoutRequest
	8, // 6: purchase.PurchaseService.HasPurchased:input_type -> purchase.HasPurchasedRequest
	4, // 7: purchase.PurchaseService.AddToCart:output_type -> purchase.CartResponse
	4, // 8: purchase.PurchaseService.RemoveFromCart:output_type -> purchase.CartResponse
	7, // 9: purchase.PurchaseService.Checkout:output_type -> purchase.CheckoutResponse
	9, // 10: purchase.PurchaseService.HasPurchased:output_type -> purchase.HasPurchasedResponse
