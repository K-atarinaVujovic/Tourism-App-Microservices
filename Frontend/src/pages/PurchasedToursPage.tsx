...
import { Search, BadgeDollarSign, Compass, AlertCircle, Tag as TagIcon } from 'lucide-react';
        ...
        <div className="container mx-auto p-6 space-y-8">
            <div className="space-y-2 text-center">
                ...
                <p className="text-muted-foreground text-lg">
                    Tours you have purchased and can explore at your own pace.
                </p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <Input
                        ...
                        placeholder="Search your purchased tours..."
                        className="pl-10"
                    />
                </div>
            ...
            {isError && (
                <div className="p-12 text-center border-2 border-dashed rounded-xl flex flex-col items-center gap-3">
                    ...
                    <p className="text-destructive font-medium">Failed to load your purchased tours.</p>
                ...
                <div className="p-16 text-center border-2 border-dashed rounded-xl flex flex-col items-center gap-4">
                    ...
                    {tours.length === 0 && (
                        <Button asChild className="mt-2">
                            <Link to="/tourist/tours">Explore & Buy Tours</Link>
                        </Button>
                    )}
                </div>
            )}
