...
const file_test_test_proto_rawDesc = "" +
	"\n" +
	"\x0ftest/test.proto\x12\x04test\x1a\x1cgoogle/api/annotations.proto\"F\n" +
	...
	"\vAuthService\x12L\n" +
	"\x05Login\x12\x12.test.LoginRequest\x1a\x13.test.LoginResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/api/auth/loginB\x14Z\x12gateway/proto/testb\x06proto3"
...
var file_test_test_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: test.LoginRequest
	(*LoginResponse)(nil), // 1: test.LoginResponse
}
var file_test_test_proto_depIdxs = []int32{
	0, // 0: test.AuthService.Login:input_type -> test.LoginRequest
	1, // 1: test.AuthService.Login:output_type -> test.LoginResponse
