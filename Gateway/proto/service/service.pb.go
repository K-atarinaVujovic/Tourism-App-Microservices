...
const file_service_service_proto_rawDesc = "" +
	"\n" +
	"\x15service/service.proto\x12\aservice\x1a\x1cgoogle/api/annotations.proto\"\x12\n" +
	"\x10GetAlbumsRequest\"[\n" +
	"\x05Album\x12\x0e\n" +
	...
	"\x06albums\x18\x01 \x03(\v2\x0e.service.AlbumR\x06albums2c\n" +
	"\fAlbumService\x12S\n" +
	"\tGetAlbums\x12\x19.service.GetAlbumsRequest\x1a\x1a.service.GetAlbumsResponse\"\x0f\x82\xd3\xe4\x93\x02\t\x12\a/albumsB\x17Z\x15gateway/proto/serviceb\x06proto3"
...
var file_service_service_proto_depIdxs = []int32{
	...
	0, // 1: service.AlbumService.GetAlbums:input_type -> service.GetAlbumsRequest
	2, // 2: service.AlbumService.GetAlbums:output_type -> service.GetAlbumsResponse
